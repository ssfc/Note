...
##	Chapter 6: 查找;
###	Node 6.1: 查找的基本概念;
查找; 查找表(查找结构); 静态查找表, 动态查找表; 关键字; 平均查找长度; (2018-11-1)
###	Node 6.2: 顺序查找和折半查找;
####	List 6.2.1: 顺序查找;
一般线性表的顺序查找; 通过引入哨兵, 可以避免很多不必要的判断语句; 有序表的顺序查找; (2018-11-2)
####	List 6.2.2: 折半查找;
仅适合线性表的顺序存储结构; (2018-11-2)
####	List 6.2.3: 分块查找;
####	List 6.2.4: 本节试题精选;
选择8, ceil(log2(n+1)); 选择15, 别忘了+1-1; (2018-12-13)
	
###	Node 6.3: B树和B+树;
####	List 6.3.1: B树及其基本操作;
B树的高度, 磁盘存取次数; B树的查找; (2018-11-12)
####	List 6.3.3: 本节试题精选;
选择16, 文件系统; 解答5, 查找失败的长度; (2018-12-14)
	
###	Node 6.4: 散列(Hash)表;
####	List 6.4.1: 散列表的基本概念;
散列函数; 冲突; 同义词; 散列表; (2018-11-12)
####	List 6.4.2: 散列函数的构造方法;
直接定址法; H(key)=a*key+b; H(key)=key%p; 数字分析法; 数字分析法; 平方取中法; 折叠法; (2018-11-12)
####	List 6.4.2: 处理冲突的方法;
开放定址法; 线性探测法; 平方探测法; 再散列法; 伪随机序列法; 拉链法; (2018-11-12)
####	List 6.4.4: 散列表查找及性能分析;
查找效率取决于散列函数, 处理冲突和装填因子; (2018-11-13)
	
###	Node 6.5: 字符串模式匹配;
####	List 6.5.1: 简单的模式匹配算法;
####	List 6.5.2: 改进的模式匹配算法--KMP算法;
	
	
##	Chapter 7: 排序;
###	Node 7.1: 排序的基本概念;
####	List 7.1.1: 排序的定义;
排序; 算法的稳定性; 比较和移动; (2018-11-14)
	
###	Node 7.2: 插入排序;
####	List 7.2.1: 直接插入排序;
稳定的排序方法; 适用于顺序存储和链式存储的顺序表; (2018-11-14)
####	List 7.2.2: 折半插入排序;
稳定的排序方法; (2018-11-14)
####	List 7.2.3: 希尔排序;
不稳定; (2018-11-14)
...
###	Node 7.3: 交换排序;
####	List 7.3.1: 冒泡排序;
最小的元素如气泡一般逐渐往上漂浮直到水面; 稳定的排序算法; (2018-11-15)
####	List 7.3.2: 快速排序;
不稳定; (2018-11-15)
	
###	Node 7.4: 选择排序;
每一趟选出关键字最小的元素; (2018-11-16)
####	List 7.4.1: 简单选择排序;
简单选择排序是一个不稳定的排序方法; (2018-11-16)
####	List 7.4.2: 堆排序;
小根堆; 大根堆; 交换n和n/2; 练习题1, 实在搞不定就行特殊值; (2018-11-18)
	
###	Node 7.5: 归并排序和基数排序;
####	List 7.5.1: 归并排序;
稳定; (2018-11-19)
####	List 7.5.2: 基数排序;
不是基于比较进行排序的; 稳定; (2018-11-18)
	
###	Node 7.6: 各种内部排序算法的比较及应用;
####	List 7.6.1: 内部排序算法的比较;
####	List 7.6.2: 内部排序算法的应用;
	
###	Node 7.7: 外部排序;
####	List 7.7.1: 外部排序的基本概念;
####	List 7.7.2: 外部排序的方法;
####	List 7.7.3: 多路归并与败者树;
####	List 7.7.4: 置换-选择排序(生成初始归并段);
####	List 7.7.5: 最佳归并树;

	
#	2018真题
填空1, 注意是循环; 填空5, 注意A[4][5]含义; 填空8, 递增顺序;
