...
19.	
20.	
21.	Chapter 2, 模型评估和选择; 
22.	2.1, 经验误差和过拟合; overfitting; underfitting; model selection; (2019-7-25)
23.	2.2, 评估方法; testing set; testing error; 留出法hold-out; 交叉验证法cross validation; 留一法leave-one-out; 自助法bootstrapping; 调参与最终模型; (2019-7-25)
24.	2.3, 性能度量; 均方误差mean square error; 错误率与精度; 查准率, 查全率和F1; ROC和AUC; 代价敏感错误率和代价曲线; (2019-7-25)
